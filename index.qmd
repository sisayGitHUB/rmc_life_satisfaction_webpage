...
author: "Sisay Wondaya Adall" # Remember to add your name!
date: "16-10-2024"
theme: united
---
...
cantril_mini <- cantril %>%
  filter(Country %in% c("India","China","Ghana","Ethiopia","Norway", "Australia" )) 

# ggplot
line_chart<-ggplot(cantril_mini, aes(x = Year, y = `Cantril ladder score`, col = Country, group = Country)) +
  geom_line() +  # Add lines
  scale_y_continuous(limits=c(0,10))+
   labs(title = "Satisfaction score of country over time: 2011-2023",
       x = "Year",
       y = "Cantril ladder score",
       color = "Country") +  # Label for the color legend
  theme_minimal() 
ggplotly(line_chart)
```
